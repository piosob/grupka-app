...
### [X] 1.1 Rejestracja nowego użytkownika
...
### [X] 2.1 Utworzenie grupy

1. Będąc zalogowanym (Użytkownik A) na `/dashboard`, kliknij przycisk "Utwórz grupę".
2. Sprawdź czy otworzył się dialog i czy widnieje w nim informacja o ujawnieniu adresu email administratora (kanał awaryjny).
