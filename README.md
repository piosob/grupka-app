...
- **Temporary Invitation Codes**: Secure 60-minute invitation codes generated by administrators
...
- **AI Assistant**: Magic Wand feature for generating gift list suggestions from parent notes
...
- **OpenRouter.ai** - Access to various AI models (OpenAI, Anthropic, Google, etc.) with cost controls and limits
...
- Group member management (invite with 60min codes, remove members)
- AI-assisted profile editing using OpenRouter
...
- AI integration for gift list generation
...
- **AI Adoption**: Percentage of child profiles saved after using Magic Wand feature
